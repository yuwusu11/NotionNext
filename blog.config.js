...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [0, 24], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '玉无玊', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '思考家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2953609208@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20230708号', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '月がきれい',
      artist: '東山奈央',
      url: 'http://music.163.com/song/media/outer/url?id=480097178.mp3',
      cover:
          'http://p1.music.126.net/3Cpj_jrscHguYjjFeO1yHg==/19242552997853427.jpg'
    },
    {
      name: '北方女王',
      artist: '尧十三',
      url: 'http://music.163.com/song/media/outer/url?id=1395785582.mp3',
      cover:
          'http://p1.music.126.net/8ANrpEn5C1NGMgk1MzhsJA==/109951164416124053.jpg'
    },
     {
      name: '小小的手心',
      artist: 'Riya',
      url: 'http://music.163.com/song/media/outer/url?id=22707009.mp3',
      cover:
          'http://p1.music.126.net/PtLd62-khEg8iCutTdE5Vg==/109951163286813093.jpg'
    },
     {
      name: '失眠飞行',
      artist: '沈以诚/接个吻，开一枪',
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1365898499', // 对应歌单的 id
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '玉无玊', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
